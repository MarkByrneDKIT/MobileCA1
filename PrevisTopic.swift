...
struct TopicView5: View {
    ...
    let images = ["previs", "frameforge"]
    
    let items = [
        ("📚🤔 Previsualisation 🤔📚", "previs"),
        ("🔨🤔 FrameForge 3D Studio 🤔🔨", "frameforge")
    ]
    ...
    let descriptions = [
        ...
        ("FrameForge 3D Studio is an emmy award winning popular previsualisation tools")
    ]
    
    let ytLinks = [
        ("https://www.youtube.com/watch?v=3czLCdX5QG4"),
        ("https://www.youtube.com/watch?v=wiBZgP0FTbo")
